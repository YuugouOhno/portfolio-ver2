...
const Presentation = () => {
    return (
        <section id="presntation" className="pb-96 pt-20 w-screen flex flex-col justify-center items-center text-black bg-white dark:text-white dark:bg-black z-40 relative">
